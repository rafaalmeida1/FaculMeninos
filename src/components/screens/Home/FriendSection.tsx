...
export function FriendsSection() {
    return (
        <View className="flex flex-col w-full gap-1 px-5">
            <Text className="text-[#DF3222] text-base font-medium">
                Ver amigos
            </Text>
            <View className="p-4 rounded-lg bg-[#D9D9D9] flex flex-col items-stretch gap-1 w-full">
                <View className="flex flex-row gap-1 items-stretch w-full">
                    <View className="flex flex-col flex-1 p-1 items-center justify-center gap-2  rounded-lg bg-zinc-100">
                        <ManIcon />
            ...
            <View className="h-screen bg-black"></View>
        </View> 
    );
}
